        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpirationMonth = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    ExpirationYear = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderDate = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowOnPageAsMonthlyHighLight = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShowOnPageAsDailyHighLight = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShowOnPageAsSpecialOffer = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShowOnPageAsPopular = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPrice = table.Column<decimal>(type: "decimal(18,1)", precision: 18, scale: 1, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
